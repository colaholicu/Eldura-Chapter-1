void spawnZombies(object mortul, object pc)
{
    ...
    for (i = 1; i < 12; ++i)
    {
        ...
        DelayCommand(2.5f, DestroyObject(zombie));
    }
    ...
    DelayCommand(6.0f, FadeToBlack(pc));
    DelayCommand(8.0f, SetCutsceneMode(pc, FALSE));
    DelayCommand(8.1f, AssignCommand(pc, ActionJumpToLocation(GetLocation(GetObjectByTag("e1_dream_one_start")))));
    DelayCommand(10.0f, FadeFromBlack(pc, FADE_SPEED_SLOWEST));
}
