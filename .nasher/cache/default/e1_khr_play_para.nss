...
void main()
{
    //if (GetLocalInt(OBJECT_SELF, "IsParalyzed"))
    //{
    //    AssignCommand(OBJECT_SELF, ActionPlayAnimation(ANIMATION_FIREFORGET_SPASM, 1.0f, 2000.0f));
    //    return;
    //}                   ANIMATION_LOOPING_SPASM


    if (GetLocalInt(OBJECT_SELF, "IsParalyzed") == 1)
    {
        PlayAnimation(ANIMATION_LOOPING_SPASM, 1.0f, 2000.f);
        return;
    }
